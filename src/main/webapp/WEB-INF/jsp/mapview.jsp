...
<body onload="getLocation()" class="dark-edition">
	<div class="wrapper ">
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item active "><a class="nav-link"
						href="/mapview"> <i class="material-icons">location_ons</i>
							<p>Maps</p>
					</a></li>
					<li class="nav-item "><a class="nav-link" href="/logout"
						onclick="{return function3();}"> <i class="material-icons">notifications</i>
							<p>logout</p>
					</a></li>
				</ul>
			</div>
			...
			<div class="content">
				<div class="container-fluid">
					...
					<label>Address: </label> <input type="text" id="address"
						value="${user.address}" />
					<button class="btn btn-success" onclick="getLocation();">Get
						Location</button>
		...
		<!--  Google Maps Plugin    -->
		<!--   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCIzTZU8ariH_C22VUiJKFq1b9t7IA3_Pg"></script> -->
		<!-- Chartist JS -->
